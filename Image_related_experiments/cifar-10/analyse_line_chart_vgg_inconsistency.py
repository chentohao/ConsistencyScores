...
methods = {
    "LIME": [0.1920, 0.4553, 0.6863, 0.8568],
    "SHAP": [0.0689, 0.2081, 0.4200, 0.6893],
    "Grad-CAM": [0.0730, 0.2160, 0.4554, 0.6968],
    "IG": [0.3002, 0.5562, 0.7167, 0.8256]
}
...
# 保存图像
plt.savefig('inconsistency_under_dropout_vgg_v2.svg', dpi=600, bbox_inches='tight')
plt.show()