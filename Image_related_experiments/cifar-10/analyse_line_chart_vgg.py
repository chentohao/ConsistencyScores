...
methods = {
    "LIME": [0.8080, 0.5447, 0.3137, 0.1432],
    "SHAP": [0.9311, 0.7919, 0.5800, 0.3107],
    "Grad-CAM": [0.9270, 0.7840, 0.5446, 0.3032],
    "IG": [0.6998, 0.4438, 0.2833, 0.1744]
}
...
# 保存图像
plt.savefig('consistency_under_dropout_vgg_v2.svg', dpi=600, bbox_inches='tight')
plt.show()