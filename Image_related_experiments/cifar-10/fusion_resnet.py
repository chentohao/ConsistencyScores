...
if __name__ == "__main__":
    ...
    result_dir = 'fusion/resnet18/result_0.7_with_fusion'
    ...
    for img_idx, (img_tensor, true_label) in enumerate(tqdm(test_loader, desc="experimental progress")):
        ...
        visualize_attr_maps(
            ...
            save_path=f'{result_dir}/sample_{img_idx:04d}_all_attr_maps.png'
        )
        ...
        visualize_drop_results(
            ...
            DROP_RATIO,
            device,
            save_path=f'{result_dir}/sample_{img_idx:04d}_all_drop_results.png'
        )
        ...
        visualize_final_attr_map(
            ...
            save_path=f'{result_dir}/sample_{img_idx:04d}_final_attr_map.png'
        )
