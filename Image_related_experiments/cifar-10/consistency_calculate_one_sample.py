...
def visualize_attr_maps(img_original, attr_maps, method_names, save_path='attr_maps_all.svg'):
...
def visualize_drop_results(img_original, dropped_imgs, method_names, drop_ratio, device, save_path='drop_results_all.svg'):
    n_methods = len(method_names)
    fig, axes = plt.subplots(1, n_methods + 1, figsize=(4*(n_methods + 1), 4))
...
if __name__ == "__main__":
    ...
    visualize_attr_maps(
        ...
        save_path=f'{result_dir}/sample_{TARGET_SAMPLE_INDEX:04d}_attr_maps.svg'
    )
    ...
    visualize_drop_results(
        ...
        DROP_RATIO,
        device,
        save_path=f'{result_dir}/sample_{TARGET_SAMPLE_INDEX:04d}_drop_results.svg'
    )
